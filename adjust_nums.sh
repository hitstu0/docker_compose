...
then
   ...
   do
       ...
       containerId=$(docker run -d -l SERVICE_ApiHost=120.77.221.92 -l SERVICE_ApiPort=8083 -l SERVICE_Weight=3 -p ${port}:${port} -v /logs/${image_name}/${port}:/log  --name="${image_name}_${port}" ${image_name}\
